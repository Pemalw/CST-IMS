...
export default function SinglePost() {
  ...
  return (
    <div className="singlePost bg-base-200 pb-10">
      ...
      <div className="navbar px-5">
        <button type="button" className="flex items-center justify-center w-1/3 sm:w-auto px-2 py-2 text-sm text-gray-700 transition-colors duration-200 bg-blue-300 border rounded-lg gap-x-2 dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-700">
          <svg className="w-4 h-5 rtl:rotate-180" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
